...
`,s=({profile:t,introduction:v,experiences:y,skills:S,experienceTitle:A,projects:P})=>{const C=P.map(d=>i`<${m} ...${d}>${d.description}</${m}>`);return i`
		<${u}>
			<${c} ...${t}>
				${t}
				<${p} groups=${S}></${p}>
...
`,a=T.bind({});a.args={profile:i`
    ...
    `,experienceTitle:"History",experiences:[{label:"Current",content:i`
            ...
            `,images:["http://sebbdk.github.io/Curriculum-Vitae/1.cb63fed2.jpg","http://sebbdk.github.io/Curriculum-Vitae/2.e1f50e8b.jpg","http://sebbdk.github.io/Curriculum-Vitae/3.00d6f55e.jpg"],tags:["Website","PHP","Booking","Fitness"]}]};var f,w,k;a.parameters={...a.parameters,docs:{...(f=a.parameters)==null?void 0:f.docs,source:{originalSource:"args => html`\n    <${BasePage}>\n        <${ResumePage} ...${args}></${ResumePage}>\n    </${BasePage}>\n`",...(k=(w=a.parameters)==null?void 0:w.docs)==null?void 0:k.source}}};const L=["primary"];export{L as __namedExportsOrder,E as default,a as primary};
