import{d as c}from"./styled-components.browser.esm-LOVPg310.js";function s(i,e){var n=!1;i[0]=="#"&&(i=i.slice(1),n=!0);var t=parseInt(i,16),r=(t>>16)+e;r>255?r=255:r<0&&(r=0);var o=(t>>8&255)+e;o>255?o=255:o<0&&(o=0);var a=(t&255)+e;return a>255?a=255:a<0&&(a=0),(n?"#":"")+(a|o<<8|r<<16).toString(16)}const g={largeMobile:"@media only screen and (min-width: 414px)",smallDesktop:"@media only screen and (min-width: 896px)",desktop:"@media only screen and (min-width: 1280px)"},l={primary:"#E92763"},f={text:s(l.primary,0)},m=c`
    @font-face {
